							...
							<div class="responsive-tabs responsive-tabs-default offset-top-40 responsive-tabs-default-variant-2 text-left">
								...
								<!--Cremation-->
										...
										<div class="range">
											<div class="cell-sm-6">
												<div class="pricing-table-variant-1">
													<div class="title">
														<div class="h5">Абонемент на 1 год</div>
													</div>
													<div class="price">
													...
													<?php Pjax::begin(['id' => 'cart-pjax']);?>
														...
														<?= $form->field($cart, 'type')->hiddenInput(['value' => 'service'])->label(false); ?>
														<?= $form->field($cart, 'category')->hiddenInput(['value' => 'clining-8'])->label(false); ?>
														<?= Html::submitButton('Добавить', ['class' => 'btn btn-sm btn-primary btn-width-full', 'name' => 'clining-button']) ?>
														<?php ActiveForm::end();?>
													<?php Pjax::end();?>
													</div>
												</div>
											...
											<div class="cell-sm-6">
												<div class="pricing-table-variant-1">
													...
													<div class="price">
														<div class="h2">6000 руб.</div>
													</div>
													<div class="pricing-table-body">
														<ul class="list-marked list-marked-variant-2">
															<li>6 уборок в год</li>
														</ul>
													</div>
													<div class="table-footer">
											...
											<div class="cell-sm-6 offset-top-40">
												<div class="pricing-table-variant-1">
													...
													<div class="price">
														<div class="h2">4000 руб.</div>
													</div>
													<div class="pricing-table-body">
														<ul class="list-marked list-marked-variant-2">
															<li>4 уборок в год</li>
														</ul>
													</div>
													<div class="table-footer">
														<a href="#" class="btn btn-sm btn-primary btn-width-full">Заказать</a>
											...
											<div class="cell-sm-6 offset-top-40">
												<div class="pricing-table-variant-1">
													<div class="title">
														<div class="h5">Абонемент на год</div>
													</div>
													<div class="price">
														<div class="h2">2200 руб.</div>
													</div>
													<div class="pricing-table-body">
														<ul class="list-marked list-marked-variant-2">
															<li>2 уборок в год</li>
														</ul>
													</div>
													<div class="table-footer">
														<a href="#" class="btn btn-sm btn-primary btn-width-full">Заказать</a>
											...
											<div class="cell-sm-12 offset-top-40">
												<div class="pricing-table-variant-1">
													<div class="title">
														<div class="h5">Абонемент одноразовый</div>
													</div>
													<div class="price">
									...
									<div>
										...
										<p class="offset-top-20">Текст для "Доставки памятников". Текст для "Доставки памятников". Текст для "Доставки памятников". Текст для "Доставки памятников". Текст для "Доставки памятников". Текст для "Доставки памятников". Текст для "Доставки памятников".</p>
										<p>Текст для "Доставки памятников".Текст для "Доставки памятников".Текст для "Доставки памятников".:</p>
										<ul class="list-marked list-marked-variant-2 offset-top-10 inset-left-38">
											<li>Быстрая доставка</li>
											<li>Только трезвые водители</li>
											<li>Доставка по всей России</li>
											<li>Товары только с отечественного производства</li>
										</ul>
									</div>
									<div>
