		...
		<section class="section-88 bg-pampas">
				...
				<div class="range text-center text-md-left">
					...
					<div class="cell-md-3">
						<div class="media media-variant-1 media-active">
							...
							<div class="media-body inset-md-right-25">
								<h3 class="font-weight-bold">Этап 3</h3>
								<p class="font-weight-bold">Проверка заказа. Утвердить эксиз.</p>
							</div>
						</div>
					</div>
					<div class="cell-md-3">
            ...
            <div class="range">
              ...
              <div class="cell-lg-4 cell-sm-6 cell-lg-preffix-8 offset-xs-top-90">
                ...
                </div><a href="checkout.html" class="btn btn-primary btn-sm btn-width-full">Подтвердить заказ</a>
              </div>
            </div>
          </div>
