					...
					<div class="cell-md-3">
						<div class="media media-variant-1 media-active">
							...
							<div class="media-body inset-md-right-25">
								<h3 class="font-weight-bold">Этап 1</h3>
								<p class="font-weight-bold">Подбор тип камня, размера памятника</p>
							</div>
						</div>
					</div>
					<div class="cell-md-3">
						<div class="media media-variant-1">
							...
							<div class="media-body inset-md-right-25">
								<h3>Этап 2</h3>
								<p>ФИО усопшего, текста на памятника, гравировка.</p>
							</div>
						</div>
					</div>
					<div class="cell-md-3">
						...
						<div id="accordion" role="tablist" aria-multiselectable="true" class="panel-group offset-top-40">
								...
								<div id="collapseOne" role="tabpanel" aria-labelledby="headingOne" class="panel-collapse collapse in">
									<div class="panel-body">
										<select>
											...
											<option>Гранит Букинский</option>
											<option>Гранит Красный</option>
										</select>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div id="collapseThree" role="tabpanel" aria-labelledby="headingThree" class="panel-collapse collapse">
									<div class="panel-body">
										<select>
											<option>60х40х5</option>
											<option>60х40х5</option>
											<option>60х40х5</option>
											<option>80х50х5</option>
											<option>80х50х5</option>
											<option>80х50х5</option>
											<option>120х60х5</option>
											<option>120х60х5</option>
											<option>120х60х5</option>
										</select>
									</div>
